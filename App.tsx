...
// ⚡ Bolt Performance Optimization: Extract ReactMarkdown components statically
// This prevents the components object and inner function components from being
// recreated on every single render cycle, which causes all child elements to unmount
// and remount, severely impacting chat performance as history grows.
