...
// ⚡ Bolt Optimization
// Why: Static ReactMarkdown components prevent unnecessary unmounting/remounting on every render
// Impact: Eliminates component recreation per-frame, preventing significant React render delays
