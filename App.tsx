...
// ⚡ Bolt Optimization:
// Why: Moving the react-markdown custom components definition outside of the main App component
// prevents the object and all its inline functions from being unnecessarily recreated on every render.
// Impact: This reduces memory allocation and avoids forced unmounting/remounting of ReactMarkdown DOM nodes, significantly improving rendering performance during active chats.
