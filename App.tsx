...
// ⚡ Bolt: Extracting the markdown components object statically outside the render loop.
// Previously, this object was defined inline inside the components prop, which caused
// React to create new function references on every single render. This led to full
// unmounting and remounting of all markdown nodes in the chat history, causing severe
// performance degradation during active typing. Moving it here prevents this anti-pattern.
