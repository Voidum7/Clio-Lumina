...
// Extracted outside the component to prevent unnecessary re-renders of the markdown content
// by avoiding the creation of a new components object on every App render.
