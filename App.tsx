...
// Extracting ReactMarkdown custom components statically outside the component block
// Why: Prevents unmounting and remounting of custom components on every render, which is a known performance anti-pattern.
// Impact: Significant reduction in render cycle time and memory churn.
