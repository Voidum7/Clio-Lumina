...
// ⚡ BOLT OPTIMIZATION
// Why: Defining ReactMarkdown custom components inline inside the render body causes a new object to be
//      created on every render, which forces React to unmount and remount all custom components.
// Impact: Extracting the configuration to a static reference prevents unnecessary re-renders and improves chat rendering performance.
