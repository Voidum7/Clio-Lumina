...
const StarBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // ⚡ Bolt: Cache CanvasGradient
    // Why: Creating a gradient on every requestAnimationFrame is a significant performance bottleneck.
    // Impact: Avoids unnecessary memory allocation and GPU overhead per frame.
