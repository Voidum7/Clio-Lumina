...
// What: Extracted ReactMarkdown components to a static object outside the render cycle.
// Why: When defined inline, the components object is recreated on every render.
//      ReactMarkdown sees a new object reference and unmounts/remounts the entire markdown tree.
// Impact: Eliminates massive unmount/remount cycles during typing and new messages.
//         Reduces CPU usage and prevents input lag as chat history grows.
