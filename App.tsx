...
/*
 * ⚡ Bolt Optimization:
 * Extracted static ReactMarkdown components outside of the App component.
 * Why: Defining components inline causes React to recreate them on every render,
 * leading to unnecessary remounting of all markdown elements.
 * Impact: Prevents re-renders and improves chat performance.
 */
