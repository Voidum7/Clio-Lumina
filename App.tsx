...
// ReactMarkdown Components Extracted for Performance
// This prevents recreation of these components on every render, avoiding unnecessary unmount/remount cycles.
// Impact: Significantly reduces React rendering overhead, especially with large chat histories.
