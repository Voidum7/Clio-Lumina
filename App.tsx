...
/*
 * ⚡ Bolt Optimization: Extracted ReactMarkdown components
 * Why: Defining the components object inline inside the render loop causes it to be recreated on every render.
 *      ReactMarkdown treats a new object reference as a change, causing unnecessary unmounting and remounting of all custom components.
 * Impact: Significantly reduces re-renders and improves chat rendering performance, especially for long conversations.
 */
