...
// Why: Defining objects inline within the render loop causes them to be recreated on every render.
// This forces ReactMarkdown and all its child elements to unnecessarily re-render, reducing performance, especially in long chat histories.
// Impact: Significantly reduces React reconciliation work and component re-renders for every message in the chat history.
