...
// ⚡ Bolt Optimization: Extracted ReactMarkdown components outside of the render cycle
// Why: Prevents unnecessary recreation of all these inline functions on every render
// Impact: Eliminates unmounting and remounting of all markdown child components during typing/updates
