...
// What: Move Markdown components statically outside the App rendering scope.
// Why: Inline definition creates new function references on every render, causing full unmounts and remounts of Markdown elements for every single chat message.
// Impact: Prevents O(n) re-renders across the entire message list, significantly lowering CPU use during typing/messaging.
