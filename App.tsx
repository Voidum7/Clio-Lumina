...
// ⚡ Bolt Optimization: Extracted ReactMarkdown components outside of the render loop.
// Defining this object statically prevents it from being recreated on every render,
// which causes ReactMarkdown to unmount and remount its children, significantly degrading performance.
