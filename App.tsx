...
/*
 * ⚡ Bolt Optimization: Extracted ReactMarkdown components to static object
 * Why: Defining components inline within ReactMarkdown triggers unmounting and
 * remounting of all markdown sub-components on every single chat message render.
 * Impact: Significantly reduces React reconciliation work and DOM manipulation overhead
 * by providing a stable reference to the markdown renderers, greatly speeding up
 * scrolling and rendering of the chat history.
 */
