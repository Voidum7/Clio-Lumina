...
/*
 * PERFORMANCE OPTIMIZATION: Extracting static ReactMarkdown components
 * Why: Defining components inline inside the render method causes React to recreate the component
 * definitions on every single render. This leads to unnecessary unmounting and remounting of the
 * DOM elements, which is a significant performance anti-pattern.
 * Impact: Prevents DOM thrashing and excessive memory allocation during message rendering.
 */
