...
const StarBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      ...
      // Why: Creating gradients in the render loop on every frame is expensive and unnecessary
      // Impact: Significantly reduces processing time per frame, yielding smoother animation
