...
// ⚡ BOLT OPTIMIZATION
// Why: Inline object literals in React components cause the prop to change on every render, leading to unnecessary re-renders of the child component (ReactMarkdown and its children).
// Impact: Defining the components statically prevents ReactMarkdown from unmounting and remounting internal elements on every message update, significantly improving rendering performance.
