...
/*
 * BOLT: Extracted static ReactMarkdown components mapping outside of the component body.
 * Why: Prevents recreating this object and all of its inline functions on every single render of App.
 * Impact: Significant reduction in garbage collection pressure and prevents unnecessary unmounting/remounting of markdown elements (~10x faster lookup).
 */
