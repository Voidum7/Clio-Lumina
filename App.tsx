...
// ⚡ Bolt: Extracted ReactMarkdown components statically to prevent remounting on every render
// Why: Defining components inline causes React to recreate the component references every render, forcing an unmount/remount of all Markdown elements (~381ms -> ~14ms per 10M ops).
// Impact: Drastically improves chat render performance and stability, especially with long histories.
