...
// Optimization: Define markdown components statically outside the App component
// Why: Prevents recreating these function components on every render of App.tsx
// Impact: Reduces unnecessary React re-renders and ReactMarkdown unmount/remount cycles
