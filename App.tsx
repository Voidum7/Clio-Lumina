...
// ⚡ BOLT OPTIMIZATION: Extracting the markdown components object outside the component
// prevents React from creating a new reference on every render. This completely eliminates
// unnecessary unmounting and remounting of all markdown elements across all chat messages,
// drastically reducing DOM trashing and improving render performance for large chat histories.
