...
// Bolt: Extracting components object outside of the App component prevents a new object
// reference from being created on every render. This avoids unnecessary re-renders of
// ReactMarkdown and its children for every chat message when the App state updates.
