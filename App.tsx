...
/*
 * ⚡ Bolt: Extract ReactMarkdown Components
 * What: Moved the ReactMarkdown custom components object outside of the `App` component body.
 * Why: Defining the components object inline causes a new object reference to be created on every render.
 *      React-markdown interprets this as new components, leading to unmounting and remounting of all
 *      markdown elements, which is a significant performance anti-pattern.
 * Impact: Prevents unnecessary unmounting/remounting, reducing render time and memory usage.
 */
