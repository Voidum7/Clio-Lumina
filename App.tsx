...
// ⚡ Bolt: Extract ReactMarkdown components to static object
// Why: Defining react-markdown custom components inline causes them to be recreated on every render of the App component, which forces ReactMarkdown to remount all components unnecessarily.
// Impact: Significantly reduces React re-renders and memory churn during chat streaming.
