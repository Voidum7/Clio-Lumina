...
const StarBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Why: Creating a gradient on every animation frame triggers unnecessary garbage collection and CPU usage.
    // Impact: Smooths frame rates by removing the allocation of the gradient object per frame.
    ...
    const animate = () => {
      ...
      // Deep space gradient (using cached gradient)
      if (cachedGradient) {
