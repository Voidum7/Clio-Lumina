...
// ⚡ Bolt Optimization: Extracted ReactMarkdown components outside the main App body.
// Why: Prevents React from recreating these functions on every render.
// Impact: Significantly reduces unnecessary unmounting and remounting of markdown nodes, improving render performance during chat.
