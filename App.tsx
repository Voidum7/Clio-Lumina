                    ...
                    >
                        <div className="text-lg leading-relaxed font-serif">
                            {msg.isRitual ? (
                                ...
                                /*
                                  ⚡ Bolt: Extracted ReactMarkdown components to static object
                                  Why: Avoids recreating the components object on every render.
                                  Impact: Significantly reduces React reconciliation overhead and improves UI responsiveness.
                                */
                                <ReactMarkdown
