...
// Optimization: Define components statically outside the component block
// Why: Prevents recreating this large components object on every render.
// Impact: Eliminates unnecessary unmounting and remounting of all custom markdown components, significantly improving chat rendering performance.
